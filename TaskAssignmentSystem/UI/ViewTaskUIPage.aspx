...
<div style="height:800px; text-align: left;">
        ...
        <asp:Button ID="postAndForwardButton" runat="server" 
            Style="z-index: 110; left: 288px; position: absolute; top: 892px; width: 146px;" Text="Submit & Forward"
            Visible="False" OnClick="postAndForwardButton_Click" />
        <asp:Button ID="postCommentButton" runat="server" 
            Style="z-index: 111; left: 288px; position: absolute; top: 853px; width: 138px;" Text="Submit Comment" OnClick="postCommentButton_Click" />
        <asp:CheckBox ID="forwardToCheckBox" runat="server" AutoPostBack="True" 
            Style="z-index: 112; left: 288px; position: absolute; top: 819px" Text="Forward To" OnCheckedChanged="forwardToCheckBox_CheckedChanged1" Width="113px" Visible="False" />
        ...
        <asp:Label ID="errorLabel" runat="server" Style="z-index: 118; left: 251px; position: absolute;
        ...
        <asp:BulletedList ID="attachmentBulletedList" runat="server" BulletStyle="Square"
            ...
            Style="z-index: 119; left: 655px; position: absolute; top: 510px;list-style-type:none;visibility:hidden"   OnClick="attachmentBulletedList_Click">
        </asp:BulletedList>
        ...
        <asp:FileUpload ID="attachmentFileUpload" runat="server" Visible="false" Style="z-index: 121; left: 446px;
