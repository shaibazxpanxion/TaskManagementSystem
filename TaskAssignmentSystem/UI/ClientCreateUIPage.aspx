...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <div align="center" style="z-index: 102; left: 388px; width: 333px; position: absolute;
        ...
        <asp:Label ID="Label2" runat="server"  Style="z-index: 100; left: 24px;
            position: absolute; top: 43px" Text="Company Name:"></asp:Label>
        <asp:Label ID="Label8" runat="server"  Style="z-index: 101; left: 61px;
            position: absolute; top: 14px" Text="Client ID:"></asp:Label>
        <asp:Label ID="Label3" runat="server"  Style="z-index: 102; left: 26px;
            position: absolute; top: 75px" Text="Contact Person:"></asp:Label>
        <asp:Label ID="Label4" runat="server"  Style="z-index: 103; left: 38px;
            position: absolute; top: 107px" Text="Contact Date:"></asp:Label>
        <asp:Label ID="Label5" runat="server"  Style="z-index: 104; left: 62px;
            position: absolute; top: 139px" Text="Address:"></asp:Label>
        <asp:Label ID="Label6" runat="server"  Style="z-index: 105; left: 49px;
            position: absolute; top: 169px" Text="Mobile No:"></asp:Label>
        <asp:Label ID="Label7" runat="server"  Style="z-index: 106; left: 31px;
        ...
        ControlToValidate="phoneNoTextBox" Style="z-index: 100; left: 315px; position: absolute;
    ...
    <asp:Label ID="successLabel" runat="server" Style="z-index: 100; left: 249px; position: absolute;
        top: 201px; width: 283px;" ForeColor="Green"></asp:Label>
    <asp:Label ID="errorLabel" runat="server" ForeColor="Red" Style="z-index: 105; left: 251px;
        position: absolute; top: 219px; width: 309px;"></asp:Label>
    <asp:GridView ID="clientGridView" runat="server" Style="z-index: 102; left: 300px;
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <asp:Label ID="dateEGLabel" runat="server" Style="z-index: 103; left: 722px; position: absolute;
        top: 403px" Text="(mm/dd/yyyy)" Font-Bold="True"></asp:Label>
    <asp:Label ID="emailEGLabel" runat="server" Style="z-index: 104; left: 726px; position: absolute;
