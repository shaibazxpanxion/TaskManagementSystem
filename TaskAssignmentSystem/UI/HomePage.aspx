...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <div>
        <asp:BulletedList ID="tasksOfUserBulletedList" runat="server" DisplayMode="LinkButton"
            Font-Size="Large"  Style="z-index: 100;
        ...
        <asp:BulletedList ID="projectListBulletedList" runat="server" Font-Bold="False" Font-Size="Large"
            ForeColor="#0000C0" Style="z-index: 105; left: 317px; position: absolute; top: 429px" Width="300px">
        </asp:BulletedList>
        <asp:Label ID="errorLabel" runat="server" Style="z-index: 106; left: 824px; position: absolute;
