...
<body>
    ...
    <div>
        &nbsp;<table border="0" cellpadding="0" cellspacing="0" style="width: 102%; height: 99%;  100; left: 0px; position: absolute; top: 0px;">
            <tr>
        ...
        <div style="border-style: solid; border-color: inherit; border-width: thin; background-color: dodgerblue;" class="auto-style1">
            ...
            <asp:Label ID="Label2" runat="server" Style=" 101; left: 42px; position: absolute;
                top: 72px" Text="Password:  "></asp:Label>
            <asp:DropDownList ID="employeeIdDropDownList" runat="server" Style=" 102;
                left: 115px; position: absolute; top: 45px" Width="135px">
            </asp:DropDownList>
            <asp:TextBox ID="passwordTextBox" runat="server" Style=" 103; left: 115px;
                position: absolute; top: 72px" TextMode="Password" Width="129px"></asp:TextBox>
            <asp:Label ID="Label3" runat="server" Font-Bold="True" Style=" 104; left: 114px;
                position: absolute; top: 14px" Text="User Log In: "></asp:Label>
            <asp:Button ID="logInButton" runat="server" OnClick="logInButton_Click" Style=" 106;
