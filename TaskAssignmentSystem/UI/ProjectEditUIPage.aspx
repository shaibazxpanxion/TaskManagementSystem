...
<div style="height:600px">
    ...
    <asp:Label ID="Label3" runat="server" Style="z-index: 105; left: 350px; position: absolute;
        top: 397px" Text="Description"></asp:Label>
                ...
                <asp:GridView ID="projectGridView" runat="server" style="z-index: 114; left: 376px; position: absolute; top: 676px">
                </asp:GridView>
    ...
    <asp:Label ID="successLabel" runat="server" ForeColor="Green" Style="z-index: 116;
        left: 264px; position: absolute; top: 220px"></asp:Label>
    <asp:Label ID="errorLabel" runat="server" ForeColor="Red" Style="z-index: 118; left: 267px;
        position: absolute; top: 244px"></asp:Label>
        <table>
       <%-- <tr>
