    ...
    <div style="height: 600px">
        ...
        <div>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                ControlToValidate="employeePhoneTextBox" Style="z-index: 100; left: 642px; position: absolute; top: 454px; width: 220px;"
            ...
            <asp:Button ID="saveButton" runat="server" Style="z-index: 114; left: 479px; position: absolute; top: 577px"
                Text="Save" Width="94px" OnClick="saveButton_Click" />
            <asp:Label ID="successMessageLabel" runat="server" Style="z-index: 115; left: 246px; position: absolute; top: 191px"
            ...
            <asp:Label ID="Label8" runat="server" Style="z-index: 119; left: 638px; position: absolute; top: 539px"
                Text="(mm/dd/yyyy)" Font-Bold="True"></asp:Label>
            <asp:Label ID="errorMessageLabel" runat="server" Style="z-index: 121; left: 250px; position: absolute; top: 204px; right: 1166px;"
