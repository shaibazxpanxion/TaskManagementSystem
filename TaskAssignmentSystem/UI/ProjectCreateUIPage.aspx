...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="352px" Style="z-index: 100; left: 341px;
        ...
        <asp:Label ID="dateEGLabel" runat="server" Height="18px" Style="z-index: 115; left: 311px;
            position: absolute; top: 132px" Text="(mm/dd/yyyy)"></asp:Label>
        <asp:Label ID="Label8" runat="server" Height="18px" Style="z-index: 116; left: 312px;
            position: absolute; top: 104px" Text="(mm/dd/yyyy)"></asp:Label>
    ...
    <asp:Label ID="successLabel" runat="server" Style="z-index: 102; left: 267px; position: absolute;
        top: 223px; height: 19px;" ForeColor="Green"></asp:Label>
    <asp:Label ID="errorLabel" runat="server" ForeColor="Red" Style="z-index: 105; left: 269px;
        position: absolute; top: 251px"></asp:Label>
    <asp:GridView ID="projectGridView" runat="server" Style="z-index: 104; left: 312px;
